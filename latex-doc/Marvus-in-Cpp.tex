...
\begin{document}
	...
	\begin{titlepage}
		\begin{center}
			{\Large \textbf{My Private Project}} \\
			{\Large C++ \& GTK4} \\
			\vfill
	...
	\input{chapters/introduction/chapter_introduction.tex}
	
	\input{chapters/core/chapter_core_classes.tex}
	
	\input{chapters/gtk/chapter_gtk.tex}

	\input{chapters/database/chapter_database.tex}
	
	\chapter*{Summary}
	
	\newpage
	\addcontentsline{toc}{chapter}{Additions}
